...
/**
 * Joins several {@link RecyclerView.Adapter}, layouts and other {@link Joinable} into
 ...
 * @see RvJoiner.Joinable
 * @see JoinableAdapter
 * @see JoinableLayout
 * @see  RvJoiner.PositionInfo
 * @see  RvJoiner.RealPositionProvider
 */
