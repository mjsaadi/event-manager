...
public class SecondTab extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        recyclerView = (RecyclerView) rootView.findViewById(R.id.rv_secondtab_assigned);
    ...
    private void retriveTeams() {
        final String event = SharedPref.getInstance(getContext()).getUser().getEvent();
        teamList.clear();
        ...
        class RetrieveTeams extends AsyncTask<Void, Void, String> {
            ...
            protected String doInBackground(Void... voids) {
                ...
                Log.d("JNAMe",SharedPref.getInstance(getContext()).getUser().getLoginCode());
